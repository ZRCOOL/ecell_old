...
<head>
	...
	<title>Initiatives - Entrepreneurship Cell | KIIT University</title>
						...
						<li class="appear-animation" data-appear-animation="fadeInUp">
							...
							<div class="featured-box" >
								<div class="box-content">
									...
									<a href="{{url('icamp')}}" class="btn btn-primary btn-icon"><i class="fa fa-external-link"></i>Main Page</a>
									</p>
								</div>
							</div>
						</li>
